 ...
 */
class RecyclerViewComponent(private val recyclerViewStyle: (RecyclerView.() -> RecyclerView.Adapter<*>)) : BaseComponent<_RecyclerView>() {
    ...
    override fun createContent(parent: _RecyclerView) {
        val adapter = recyclerViewStyle.invoke(parent)
